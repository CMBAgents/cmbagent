        ...
        if os.path.isdir(subdir_path):
            for filename in os.listdir(subdir_path):
                if filename.endswith(".py") and filename != "__init__.py" and filename[0] != ".":
                    ...
                    # print(f"✅ Loaded non-RAG agent: {class_name} from {module_path}")
...
class CMBAgent:
    ...
    def __init__(self,
                ...
                #  agent_list = ['act', 'camb', 'classy', 'classy_sz', 'cobaya', 'cosmocnc', 'getdist', 'memory', 'planck', 'tszpower'],
                 agent_list = ['planck', 'tszpower'],
                 verbose = False,

...
class Subtasks(BaseModel):
    ...
    sub_task_agent: Literal["engineer", "researcher", "idea_maker", "idea_hater", "classy_sz_agent", "camb_agent"] =  Field(..., description="The name of the agent in charge of the sub-task")

...
class Subtasks(BaseModel):
    ...
    sub_task_agent: Literal["engineer", "researcher", "idea_maker", "idea_hater", "classy_context", "camb_context"] =  Field(..., description="The name of the agent in charge of the sub-task")

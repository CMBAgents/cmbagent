...
class ClassyResponseFormatterAgent(BaseAgent):
    ...
    class PythonCode(BaseModel):
        code: Optional[str] = Field(None, description="The draft of the Python code needed for classy")
    ...
    class ClassyResponse(BaseModel):
        ...
        python_code: "ClassyResponseFormatterAgent.PythonCode" = Field(..., description="Python code snippet related to the task.")
